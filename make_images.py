...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str,
                        default="/home/mil/r-ishikawa/small-dataset-image-generation/configs/default.yml")
    ...
    if not os.path.exists('./' + args.save + '/random'):
        os.mkdir('./' + args.save + '/random')
    if not os.path.exists('./' + args.save + '/recon'):
        os.mkdir('./' + args.save + '/recon')
    if not os.path.exists('./' + args.save + '/interpolate'):
        os.mkdir('./' + args.save + '/interpolate')
    # Model
    ...
    with chainer.using_config("train", False), chainer.using_config("enable_backprop", False):
        ...
        for i in range(200):
            ...
            for j in range(len(xs[i])):
                ...
                pil_img = pil_img.resize((224, 224))  # not good
